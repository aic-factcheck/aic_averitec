...
def generate_questions_top_k(reference_corpus="data/train.json", target_file="data/dev.json", top_k_target_knowledge="data_store/dev_top_k_sentences.json", output_questions="data_store/dev_top_k_qa.json", top_k=100):
